import flet as ft
import re
from services.AddRecipeBackend import load_recipes, add_recipe, save_recipes
...
def get_addrecipeview(page):
    ...
    def on_submit(e):
        ...
        origin = origin_input.value.capitalize()
        ...
        new_recipe = {
            ...
            "difficulty": "Easy", # Needs to be implemented
    ...
    addrecipeHeader = Header("Add a Recipe", page)

    main_column = ft.Column(
        controls=[
            addrecipeHeader.build(),
            scrollable_area,
            submit_button
        ],
        expand=True,
